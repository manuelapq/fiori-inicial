		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoice List",
									"targetURL": "#pruebainvoices1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pruebainvoices1-display": {
								"semanticObject": "pruebainvoices1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=prueba.invoices1",
									"url": sap.ui.require.toUrl("prueba/invoices1")
								}
							}
						}
					}
